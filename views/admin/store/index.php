...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      ...
      <button class="btn btn-primary <?= $insert ?>" data-toggle="modal" data-target="#addModal">Add Area</button>
      <br /> <br />
...
?>
  ...
  <td><button type="button" class="btn btn-default <?= $update ?>" onclick="editFunc(<?php echo '\'' . $value->id_store . '\'' ?>, this)" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-default <?= $delete ?>" onclick="removeFunc(<?php echo '\'' . $value->id_store . '\'' ?>, this)" data-toggle="modal" data-target="#removeModal"><i class="fa fa-trash"></i></button></td>
</tr>
          ...
          <form role="form" action="#" method="post" id="createForm">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="brand_name">Area Name</label>
                <input type="text" class="form-control" id="store_name" name="store_name" placeholder="Enter Area name" autocomplete="off">
              ...
              <div class="form-group"  >
                ...
                <p id="err_active" class="hide-elm text-danger">The Area name field is required.</p>
              </div>
            </div>
          ...
          <form role="form" action="stores/update" method="post" id="updateForm">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control  load-data" id="edit_store_name" name="edit_store_name" value="1" placeholder="Enter Area name" autocomplete="off">
...
<script  src="assets/admin/dist/js/store.js?ver=01"></script>
