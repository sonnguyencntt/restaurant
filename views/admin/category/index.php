<section class="content">
    ...
    <div class="row">
      ...
      <a href="?controller=category&type=admin&action=create" class="btn btn-primary <?= $access['insert'] ?>">Add Product</a>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal" data-keyboard="false" data-backdrop="static">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form role="form" action="?controller=category&action=delete&type=admin" method="post" id="removeForm">
