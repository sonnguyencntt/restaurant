...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      ...
      <button class="btn btn-primary <?= $insert ?>" data-toggle="modal" data-target="#addModal">Add Category</button>
      <br /> <br />
            ...
            <tbody>
              ...
              ?>
                <tr role="row" class="odd">
                  ...
                  <td><button type="button" class="btn btn-default <?= $update ?>" onclick="editFunc(<?php echo '\'' . $value->id_category . '\'' ?>, this)" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-default <?= $delete ?>" onclick="removeFunc(<?php echo '\'' . $value->id_category . '\'' ?>, this)" data-toggle="modal" data-target="#removeModal"><i class="fa fa-trash"></i></button></td>
                </tr> 
        ...
        <form role="form" action="#" method="post" id="createForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <p id="err_category_name" class="hide-elm text-danger">The Category name field is required.</p>
            </div>
            <div class="form-group">
              ...
              <p id="err_active" class="hide-elm text-danger">The Category name field is required.</p>
            </div>
          </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" method="post" id="updateForm">
          <div class="modal-body">
            <div id="messages"></div>
            <input type="hidden" id="edit_id_category" name="edit_id_category">
            <div class="form-group">
              <label for="brand_name">Category Name</label>

              <input type="text" class="form-control  load-data" id="edit_category_name" name="edit_category_name" value="1" placeholder="Enter Category name" autocomplete="off">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form role="form" action="#" method="post" id="removeForm">
          <div class="modal-body">
            <input type="hidden" name="remove_id_category">
...
<script src="assets/admin/dist/js/category.js?ver=01"></script>