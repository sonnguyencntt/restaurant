...
<head>
  ...
  <title>Login</title>
  <base href="http://restaurant.localhost/" >
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    if(isset($_SESSION['message-fail-login'])){
       echo MyFunction::get_message('message-fail-login');
    }
    ?></p>
    ...
    <form action="?controller=auth&type=admin&action=login" method="post">
